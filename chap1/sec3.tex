...
\begin{figure}[ht!]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{tikzpicture}[scale=0.65]
            ...
            \draw[thick, -latex] (0, 0) -- node[above] {$\vec{r}$} ({1.5/sqrt(2)}, {-0.3*1.5/sqrt(2)});
            \draw[thick, -latex] ({1.5/sqrt(2)}, {-0.3*1.5/sqrt(2)}) -- ++ ({0.8*1.5/sqrt(2)}, {0.3*0.8*1.5/sqrt(2)}) node[right] {$\vec{v}$} ;
